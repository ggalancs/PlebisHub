...
ActiveAdmin.register VoteCircle do
  ...
  controller do
    ...
    def change_children_vote_circle(_resource)
      default_id = VoteCircle.where(code: DEFAULT_VOTE_CIRCLE).pick(:id)
    ...
    def assign_vote_circle_territory(vc)
      ...
      exterior_circles = VoteCircle.where('code not like all(array[?])', known_types).where(country_code: nil,
