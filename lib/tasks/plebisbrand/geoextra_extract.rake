...
namespace :plebisbrand do
  ...
  task geoextra_extract: :environment do
    ...
    CSV.read('db/plebisbrand/islas.tsv', { col_sep: "\t" }).each do |island|
    ...
    CSV.read('db/plebisbrand/comunidades.tsv', { col_sep: "\t" }).each do |autonomy|
