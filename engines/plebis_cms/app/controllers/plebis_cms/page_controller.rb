...
module PlebisCms
  ...
  class PageController < ApplicationController
    ...
    def show_form
      ...
      @meta_image = @page.meta_image if @page.meta_image.present?

      if @page.require_login && !user_signed_in?
        flash.now[:metas] = { description: @meta_description, image: @meta_image }
        authenticate_user!
        return
      end
    ...
    def share_car_sevilla
      render :form_iframe,
             locals: { title: 'Comparte tu coche: Destino Sevilla', url: form_url(72), return_path: root_path }
    end
    ...
    def share_car_doshermanas
      render :form_iframe,
             locals: { title: 'Comparte tu coche: Destino Dos Hermanas', url: form_url(73), return_path: root_path }
    end
    ...
    def responsables_organizacion_municipales
      render :form_iframe,
             locals: { title: 'Responsable del área de Organización / Extensión en los órganos municipales',
                       url: form_url(26) }
    end
    ...
    def alta_consulta_ciudadana
      render :form_iframe,
             locals: { title: 'Formulario para activar la Consulta Ciudadana acerca de las candidaturas de unidad popular',
                       url: form_url(57) }
    end
    ...
    def responsables_areas_cc_autonomicos
      render :form_iframe,
             locals: { title: 'Responsables de Áreas de los Consejos Ciudadanos Autonómicos', url: form_url(61) }
    end
    ...
    def comparte_cambio_valoracion_propietarios
      render :form_iframe,
             locals: { title: 'Cuéntanos como fue la experiencia compartiendo tu casa o coche', url: form_url(65) }
    end
    ...
    def cuentas_consejos_autonomicos
      render :form_iframe,
             locals: { title: 'Solicitud de cuentas institucionales para consejos Autonómicos', url: form_url(79) }
    end
