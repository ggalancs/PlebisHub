...
RSpec.describe PlebisCollaborations::Engine, type: :rails_engine do
  describe 'engine configuration' do
    ...
    it 'has the correct namespace' do
      expect(described_class.railtie_namespace).to eq(PlebisCollaborations)
    end
  end
  ...
  describe 'initializers' do
    ...
    it 'defines plebis_collaborations.check_activation initializer' do
      initializer = initializers.find { |i| i.name == 'plebis_collaborations.check_activation' }
  ...
  describe 'activation check' do
    it 'handles enabled engine' do
      ...
      result = ::EngineActivation.enabled?('plebis_collaborations')
    ...
    it 'handles EngineActivation errors gracefully' do
      ...
      expect do
        begin
          ::EngineActivation.enabled?('plebis_collaborations')
